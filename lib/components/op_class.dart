          ...
          children: [
            ...
            Center(
              child: DataTable(
                ...
                rows: [
                  getNewDataRow('Apparent\nMagnitude', widget.meanApparentMagnitude, ''),
                  getNewDataRow('Geometric\nAlbedo', widget.geometricAlbedo, ''),
                  getNewDataRow('Distance\nFrom Earth', widget.distanceFromEarth, 'm'),
                  getNewDataRow('Absolute\nMagnitude', absoluteMagnitude, ''),
                  getNewDataRow('Mean\nAngular Size', widget.meanAngularSize, 'deg'),
                ],
              ),
            ),
            ExpandedButton(
